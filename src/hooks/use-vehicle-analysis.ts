    ...
    try {
      ...
      const reportData: AnalysisResult = {
        veiculo: {
          ...
          cor: vehicleData.fipeData?.cor || "",
          combustivel: vehicleData.fipeData?.fipe?.dados?.[0]?.combustivel || vehicleData.fipeData?.Combustivel || "",
          chassi: vehicleData.fipeData?.chassi || "",
          municipio: vehicleData.fipeData?.municipio || "",
          uf: vehicleData.fipeData?.uf || "",
          situacao: vehicleData.fipeData?.situacao || "",
