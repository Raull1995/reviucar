    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
      ...
      <section className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Features Comparison */}
            <div className="mt-8 md:mt-12 lg:mt-16 max-w-4xl mx-auto px-2 md:px-0">
              <h2 className="text-xl md:text-2xl font-heading font-bold text-center text-gray-dark mb-6 md:mb-8">
                Compare os Recursos
              </h2>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          ...
          className="flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
        >
