        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex items-center gap-2">
              ...
              <span>{completeVehicleData.modelo}</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-sm">{completeVehicleData.chassi}</span>
            </div>
            <div className="flex items-center gap-2">
              <MapPin className="h-4 w-4 text-muted-foreground" />
              <span className="font-medium">Município/UF:</span>
              <span>{completeVehicleData.municipio}/{completeVehicleData.uf}</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-success">{completeVehicleData.valor_fipe}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-medium">Código FIPE:</span>
              <span className="font-mono text-sm">{completeVehicleData.codigo_fipe}</span>
            </div>
            <div className="flex items-center gap-2">
              <CreditCard className="h-4 w-4 text-muted-foreground" />
              <span className="font-medium">Placa:</span>
              <span className="font-mono font-bold text-lg">{completeVehicleData.placa}</span>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <CardContent>
            {laudo.analise_tecnica && (
              <div className="prose max-w-none mb-6">
                <h4 className="font-semibold mb-2">Parecer Técnico:</h4>
            ...
            {laudo.componentes && laudo.componentes.length > 0 && (
              <div>
                <h4 className="font-semibold mb-4">Componentes Analisados:</h4>
                <div className="space-y-3">
                  {laudo.componentes.map((componente, index) => (
                    <div key={index} className="border rounded-lg p-4 bg-muted/30">
                      <div className="flex items-start justify-between mb-2">
                        <h5 className="font-medium text-foreground">{componente.nome}</h5>
                        <Badge variant={
